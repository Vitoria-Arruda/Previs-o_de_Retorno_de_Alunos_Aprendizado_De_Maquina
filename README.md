...
É uma aplicação interativa desenvolvida em Python e Streamlit que utiliza dados históricos para calcular a probabilidade de retorno de um aluno. O sistema permite:
